...
public class Tour {
    ...
    public void insertNearest(Point p) {
        // Caso 1: tour vazio (start.p == null)
        if (start.p == null) {
            start.p = p;
            start.next = start;
            return;
        ...
        // Caso 2: tour com 1 nó (start.next == start)
        if (start.next == start) {
        ...
        // Caso 3: tour com >= 2 nós
        // Encontrar o nó mais próximo de p
        Node nearestNode = start;
        double nearestDist = start.p.distanceTo(p);
        ...
        // Inserir p logo após o nó mais próximo
        Node newNode = new Node();
        newNode.p = p;
    ...
    public void insertSmallest(Point p) {
        ...
        // Caso 3: tour com >= 2 nós
        // Percorrer todas as arestas e encontrar onde inserir causa menor aumento
        Node bestNode = null;
