 ...
 *                (blue).
 *
 *                Adaptado localmente para abrir a janela de forma robusta em
 *                ambiente desktop padrão, mantendo a estrutura do trabalho.
 ***************************************************************************** */
...
public class TSPVisualizer {
    ...
    public static void showTours(int width, int height, List<Point> points, Tour nearest, Tour smallest) {
        ...
        StdOut.println();
        StdOut.println("Janela aberta. Feche o visualizador para encerrar o programa.");
        StdDraw.waitUntilClosed();
    }
